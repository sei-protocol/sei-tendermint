...
type TxRequestMessage struct {
	Height int64    `protobuf:"varint,1,opt,name=height,proto3" json:"height,omitempty"`
	Round  int32    `protobuf:"varint,2,opt,name=round,proto3" json:"round,omitempty"`
	TxKeys [][]byte `protobuf:"bytes,3,rep,name=tx_keys,json=txKeys,proto3" json:"tx_keys,omitempty"`
	types2.TxKey
}

func (m *TxRequestMessage) Reset()         { *m = TxRequestMessage{} }
func (m *TxRequestMessage) String() string { return proto.CompactTextString(m) }
func (*TxRequestMessage) ProtoMessage()    {}
func (*TxRequestMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_81a22d2efc008981, []int{6}
}
func (m *TxRequestMessage) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TxRequestMessage) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TxRequestMessage.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TxRequestMessage) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TxRequestMessage.Merge(m, src)
}
func (m *TxRequestMessage) XXX_Size() int {
	return m.Size()
}
func (m *TxRequestMessage) XXX_DiscardUnknown() {
	xxx_messageInfo_TxRequestMessage.DiscardUnknown(m)
}

var xxx_messageInfo_TxRequestMessage proto.InternalMessageInfo

func (m *TxRequestMessage) GetHeight() int64 {
	if m != nil {
		return m.Height
	}
	return 0
...
func (m *TxRequestMessage) GetRound() int32 {
	if m != nil {
		return m.Round
	}
	return 0
...
func (m *TxRequestMessage) GetTxKeys() [][]byte {
	if m != nil {
		return m.TxKeys
	}
	return nil
...
type Message struct {
	...
	//	*Message_BlockPartRequest
	//	*Message_TxnRequestMessage
...
func (*Message) Descriptor() ([]byte, []int) {
	return fileDescriptor_81a22d2efc008981, []int{12}
}
...
type Message_BlockPartRequest struct {
	BlockPartRequest *BlockPartRequest `protobuf:"bytes,11,opt,name=block_part_request,json=blockPartRequest,proto3,oneof" json:"block_part_request,omitempty"`
}
type Message_TxnRequestMessage struct {
	TxnRequestMessage *TxRequestMessage `protobuf:"bytes,12,opt,name=txn_request_message,json=txnRequestMessage,proto3,oneof" json:"txn_request_message,omitempty"`
}
...
func (*Message_BlockPartRequest) isMessage_Sum()  {}
func (*Message_TxnRequestMessage) isMessage_Sum() {}
...
func (m *Message) GetBlockPartRequest() *BlockPartRequest {
	if x, ok := m.GetSum().(*Message_BlockPartRequest); ok {
		return x.BlockPartRequest
	}
	return nil
}

func (m *Message) GetTxnRequestMessage() *TxRequestMessage {
	if x, ok := m.GetSum().(*Message_TxnRequestMessage); ok {
		return x.TxnRequestMessage
	}
	return nil
}
...
func (*Message) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Message_BlockPartRequest)(nil),
		(*Message_TxnRequestMessage)(nil),
	}
}
...
func init() {
	...
	proto.RegisterType((*TxRequestMessage)(nil), "tendermint.consensus.TxRequestMessage")
...
var fileDescriptor_81a22d2efc008981 = []byte{
	...
	,
}
...
func (m *TxRequestMessage) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TxRequestMessage) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TxRequestMessage) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.TxKeys) > 0 {
		for iNdEx := len(m.TxKeys) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.TxKeys[iNdEx])
			copy(dAtA[i:], m.TxKeys[iNdEx])
			i = encodeVarintTypes(dAtA, i, uint64(len(m.TxKeys[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
...
func (m *Message_BlockPartRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Message_BlockPartRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.BlockPartRequest != nil {
		{
			size, err := m.BlockPartRequest.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Message_TxnRequestMessage) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Message_TxnRequestMessage) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.TxnRequestMessage != nil {
		{
			size, err := m.TxnRequestMessage.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *TxRequestMessage) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Message_BlockPartRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.BlockPartRequest != nil {
		l = m.BlockPartRequest.Size()
		n += 1 + l + sovTypes(uint64(l))
	}
	return n
}
func (m *Message_TxnRequestMessage) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TxRequestMessage) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TxRequestMessage: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TxRequestMessage: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 3:
			...
			m.TxKeys = append(m.TxKeys, make([]byte, postIndex-iNdEx))
			copy(m.TxKeys[len(m.TxKeys)-1], dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
...
func (m *Message) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BlockPartRequest", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Sum = &Message_BlockPartRequest{v}
			iNdEx = postIndex
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TxnRequestMessage", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Sum = &Message_TxnRequestMessage{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
