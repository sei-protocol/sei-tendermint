...
type Mempool interface {
	...
	CheckTx(ctx context.Context, tx types.Tx, callback func(*abci.ResponseCheckTxV2), txInfo TxInfo) error
...
type PostCheckFunc func(types.Tx, *abci.ResponseCheckTxV2) error
...
func PostCheckMaxGas(maxGas int64) PostCheckFunc {
	return func(tx types.Tx, res *abci.ResponseCheckTxV2) error {
		if maxGas == -1 {
			return nil
		}
		if res.GasWanted < 0 {
