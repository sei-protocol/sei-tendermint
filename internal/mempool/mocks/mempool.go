...
func (_m *Mempool) ReapMaxBytesMaxGas(maxBytes int64, maxGas int64, maxGasEstimate int64, minTxsInBlock int64) types.Txs {
	ret := _m.Called(maxBytes, maxGas, maxGasEstimate, minTxsInBlock)
