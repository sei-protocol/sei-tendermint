...
func decideProposal(
	...
	proposal = types.NewProposal(height, round, polRound, propBlockID, block.Header.Time, []types.TxKey{}, types.Header{}, &types.Commit{}, types.EvidenceList{}, crypto.AddressHash([]byte{}))
	p := proposal.ToProto()
